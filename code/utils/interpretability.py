...
class ModelExplainer:
    ...
    def explain_spoofing_detection(
        ...
        plt.savefig(
            os.path.join(save_dir, "temporal_attribution.png"),
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig(
            os.path.join(save_dir, "feature_attribution.png"),
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig(
            os.path.join(save_dir, "shap_importance.png"), dpi=300, bbox_inches="tight"
        )
        plt.close()
